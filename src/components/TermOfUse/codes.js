...
These Terms constitute an agreement, which includes the privacy policy (“Privacy Policy”) and the community guidelines (“Community Guidelines”) by and between Luckmon inc., (“Luckmon” or “we”) and any individual user (the “User” or “you”) that uses or accesses the Services (defined hereinafter).

‍

Luckmon reserves the right to update and change these Terms and the Services at any time and any new services, features or tools which are added to the current Services shall also be subject to the Terms of Use. You are advised to review these Terms from time to time for updates and changes that may impact you. Any use of the Services after such updates and changes will mean that you accept them. You can always review the last updated version of the Terms at [https://www.luckmon.com/Terms-Of-Use](https://www.luckmon.com/terms-of-use). Please also review from time to time our Privacy Policy at [https://www.luckmon.com/Privacy](https://www.luckmon.com/privacy) and our Community Guidelines [http://www.luckmon.com/Community-Guidelines](http://www.luckmon.com/community-guidelines).

‍

### SERVICES

The Services offered by Luckmon under the Terms consist of the Luckmon website and mobile applications (the “App”) offering rewards to Users in exchange to download and review and/or use any game suggested in the App (the “Services”).

‍

### ACCOUNT & ELIGIBILITY

Some of the Services require that you sign up for a User account. Only one (1) User account may be set up per User. Only users 18 years or older are permitted to register for a User account. Transferring or selling a User account to third parties for their own purposes is not permitted. By using the Services, you represent and warrant that (a) all information you submit to Luckmon are truthful and accurate; (b) you will maintain the accuracy of all such information; (c) you will uphold and respect these Terms at all times; (d) your use of the Services does not violate any applicable law or regulation; (e) you will safeguard your account information and will supervise and be completely responsible for any use of your Account by you and anyone other than you. Your account may be deleted without warning at Luckmon’s sole discretion if we believe that you violate any of these Terms.
...
Our App contains a social feature allowing the User to interact with other User(s). All Users are subject to our Community Guidelines detailing the rules of user conduct with respect to interacting with other Users on our App. Luckmon reserves the right to restrict User access to the social feature or indefinitely ban a User account for violation of our Community Guidelines.
...
Luckmon reserves the right to indefinitely ban any user found to be using an auto clicker program or any similar software that allows a user to falsify data relating to their phone's input, or that allows them to appear to be using their phone when in reality they have left it idle.

‍

Luckmon reserves the right to indefinitely ban any user found to be accessing the application through an emulator of any kind, regardless of the platform on which the emulator is being used.

‍

Luckmon reserves the right to ban any account associated with software that can be used to modify games, or software that can unlock in-game content for free that would otherwise need to be purchased.

‍

Luckmon reserves the right to ban any account associated with disposable email addresses that automatically forward messages to an alternate address, or that can automatically visit and open verification links that are sent to them.

‍

Luckmon reserves the right to nullify all Gems earned on any account that has been banned, and to disable the redemption of rewards on all banned accounts, regardless of the reason for which the account was banned.

‍

Luckmon reserves the right to indefinitely ban any user found to be using a rooted device or any device for which the user has been granted root access or privileged control. Rooted devices are not supported devices and may at any time be blocked from us.

‍

Luckmon reserves the right to reject any gift card purchase request issued from an account associated with a rooted device, or from any account banned for fraudulent activity.

Luckmon reserves the right to permanently ban any user account created by an individual under the age of 18.

Luckmon reserves the right to ban any account that appears to be using, downloading or accessing the app fraudulently. This includes but is not limited to users who download the App through a means other than the Google Play store, users with privileged control over their devices, users with suspicious third-party firmware on their device, users manipulating their IP address, users unable to complete the face verification or phone verification processes for fraud verification purposes, users using software that makes them appear active when they are idle, users accessing the app from an emulator of any kind, or any user attempting to fraudulently earn Gems through any means other than playing games.

‍

It is prohibited to access the Luckmon application on any device other than an Android mobile phone or tablet and doing so can result in an account ban or rejection of an order.

‍

### TERM

This Agreement will remain in full force and effect while you use the Services and/or have a Luckmon account (the “Term”). You may stop using the Services at any time, for any reason, by uninstalling the App from your mobile device. Luckmon may terminate or suspend your account at any time without notice if Luckmon reasonably believes that you have breached this Agreement. After your account is terminated, this Agreement will terminate, except for the provisions of the sections labelled “Payment & Fees”, “Intellectual Property”, “No Liability”, “No Warranty”, “Indemnity”, “Severability, Force Majeure, Entire Agreement & Headings”, “Representations and Warranties”, and “Governing Law and Language”.

‍

Upon termination of this Agreement, User shall discontinue its use of the Services. However, termination of this Agreement by Luckmon shall not limit User's obligation to pay any outstanding fees, if applicable, nor restrict Luckmon from pursuing any other remedies available to it, including injunctive relief.

‍

User agrees that following termination of User’s account and/or use of the Services, Luckmon may immediately deactivate User’s account and delete User data and accumulated rewards. User further agrees that Luckmon shall not be liable to User nor to any third party for any termination of User access to the Services or deletion of User data. The foregoing shall not apply if such termination or deletion is attributable to Luckmon’s gross negligence or willful misconduct.

‍

### PAYMENT & FEES

User agrees to pay to Luckmon any fees for each Service that User purchases, uses, or subscribes to in accordance with the pricing and payment terms presented by Luckmon for such Service. Where applicable, you will be billed using the billing method selected by the User at the moment of purchase. Luckmon refunds as prescribed in the applicable law, and for more details, please refer to the respective webpage for sales.

‍

### REWARDS

Luckmon offers loyalty points, used as virtual currency in the Luckmon apps and referred to as “Gems”, to Users in exchange for testing, reviewing and/or using the mobile games listed in the App. Luckmon does not reward for time spent in App but rather for real gametime. Leaving the App open does not constitute gameplay. Users can redeem Gems for different rewards offered by Luckmon, such as gift cards, gift certificates, prepaid cash cards or content codes (collectively “Rewards”). The Rewards cannot be redeemed for cash or in any way resold, exchanged or returned for a cash refund, unless required by law. Rewards may be redeemed in countries where applicable merchants and services are available. Luckmon is not responsible for any valid Reward which the user is unable to redeem due to their age, situation, or country of residence. Luckmon is not responsible for any lost, stolen, or malfunctioning Rewards except when it is caused by gross negligence or willful misconduct of Luckmon.

For all users 18 years or older, when redeeming a reward through our Shop, we may verify your face via a ‘video selfie’ using a third party face verification technology. We use this information exclusively for the purpose of fraud prevention and to ensure that prizes are not earned through bots, automated processes or fraudulent use of software. We will use your ‘video selfie’ exclusively for fraud prevention. Upon redeeming a reward from our Shop, you will be prompted to provide a video selfie using your mobile device’s camera. This video selfie provides us with a face map (a mathematical representation of your face generated through our third party provider, Facetec). This video selfie is encrypted on your mobile device before being sent to our servers for processing, and is linked to your user account to ensure the uniqueness of your user registration within the mobile application. If you do not want to redeem rewards through the Shop, you can continue to use all other features of the mobile application without providing a video selfie. For more information, please refer to our Privacy Policy available at [Https://Www.Luckmon.Com/Legal/Privacy](https://www.mistplay.com/legal/privacy).
...
User agrees to defend, indemnify, and hold harmless Luckmon, its affiliates and their respective directors, officers, employees, agents, and mandataries from and against all claims and expenses, including without limitation, attorneys' fees (collectively the “Costs”), to the extent that such Costs are attributable to any breach by User, of any representations, warranties, or other obligations set forth in this Agreement or arising out of the use of the Services by User.

### GOVERNING LAW AND LANGUAGE

These Terms of Service shall be construed in accordance with the laws applicable in the province of California, United States, without regard to its conflict of laws rules. User hereby agrees, for any dispute or controversy arising under or in connection with this Agreement or resulting from the Services or Corporation’s website shall be settled exclusively by arbitration in California (United States), in accordance with the Code of civil procedure of the province of California.
...
User represents and warrants that currently and throughout the Term (i) it is fully authorized to enter into this Agreement and that User is fully authorized to use the Services; and (ii) User is and will remain in compliance with all applicable laws and regulations with respect to its activities related to this Agreement, including but not limited to privacy laws. User agrees to comply with all of Luckmon’s policies and all laws, rules and regulations relating to the use of the Services. Any violation of this section may result in loss of features, up to and including termination of User’s account. User will indemnify Luckmon for any costs, fines or damages incurred by Luckmon due to User's failure to comply with this section.
`;