...
This Policy is effective when the User clicks on the “ACCEPT & CONTINUE” button during the Luckmon account creation process and by doing so, you agree that you have read and understood the terms of this Policy. If you do not agree with these terms or if you are younger than 18, you are prohibited from registering for a Luckmon user account.
...
- For legitimate interests under section 6(1)(f) of the *General Data Protection Regulation* (GDPR), including fraud prevention purposes, protection against abuse of our Services, and to guarantee that the use of our Services are in accordance with Luckmon’s [Terms Of Use](Https://www.luckmon.com/legal/terms).
...
Additionally, personal data may be used and disclosed to the extent Luckmon may deem reasonably necessary to enforce the terms of any agreement between you and Luckmon, or to protect the rights, property or safety of any person or entity, or if required by law, specifically in response to a demand from government authorities.
...
We restrict the use of our Services to individuals age 13 and above. In compliance with COPPA, we do not knowingly collect or retain Information from our Services from children under the age of 13. If we learn we have collected or received personal information from a child under 13 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 13, please contact us at info@Luckmon.Com.

For Korean residents only, we restrict the use of our Services to individuals age 14 and above. We do not knowingly collect, maintain, or use personal data from children under the age of 14. If we learn we have collected or received personal information from a child under 14 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 14, please contact us at info@luckmon.com.
...
You may make requests by writing to info@luckmon.com (see below for a description of the specific rights with respect to accessing and deleting Information that are provided to California, European, Taiwan and Korean residents). Upon receipt of such a request, Luckmon will endeavor to provide you this information (in electronic readable format) within a reasonable time. We may not accommodate a request to change information if we believe the change would violate any law or legal requirement or cause the information to be incorrect.
...
We may use third-party advertising companies to serve ads on the Service. We do not provide any personal information to third-party advertising companies on a non-aggregate basis. Our system and the third-party advertising technology may use aggregate information, non-personal information, LUCKMON Inc. cookies on your hard drive and your use of the Service to target advertisements. In addition, advertisers may use other third-party advertising technology to target advertising on other sites. If advertisements are served to you, a unique third-party cookie or cookies may be placed on your computer. Similarly, third-party advertising companies may provide us with pixel tags (also called clear gifs or beacons) to help manage and optimize online advertising. Beacons enable us to recognize a browser’s cookie when a browser visits the site on which is beacon is located, and to learn which banner ads bring users to a given site.‍

### Your California Privacy Rights

California residents have the right to request (a) information identifying any third party to whom LUCKMON Inc. may have disclosed (within the previous calendar year) his/her personal information for that third party’s direct marketing purposes; and (b) a description of the categories of personal information disclosed. If you are a California resident and wish to obtain such information, please send a request email to [info@luckmon.com](mailto:info@luckmon.com)Privacy Rights for California Minors

California residents under the age of 18 have the right to request removal of any content or information that he or she posted anywhere within our Services, such as public forums or message boards in our websites or Applications.  You can make this request by contacting us at info@luckmon.com
...
| CATEGORY | NAME/DESCRIPTION | SOURCES | BUSINESS USE | COMMERCIAL USE |
| --- | --- | --- | --- | --- |
...
Luckmon has collected, will collect, and has disclosed the personal information described in the categories above during the last year for business purposes; however, we do not sell your personal information.  If you exercise your rights under the CCPA, Luckmon will not discriminate against you.
...
| --- | --- | --- | --- | --- | --- |
| Amazon Web Services, Inc. | U.S.A | http://aws.amazon.com/privacy/ | Upon accessing and using Luckmon services | Hosting and data security and management services for the personal data that we store. Also used for analytics to monitor and track the reliability of the Services | mobile application account data such as name, email, mailing address, age, gender, language, social media profiles, application installed, time spent using an application, IP address, Google Ad ID, OS version, device model |
| Adbrix | South Korea | http://igaworks.com/ko/rule_user.html | Upon accessing and engaging with an ad and using Luckmon services | Advertising, rewards, and fraud detection |  |
| Adjust | U.S.A | http://adjust.com/terms/privacy-policy/ | Upon accessing and engaging with an ad and using Luckmon services | Advertising, rewards, and fraud detection | Mobile application Google Ad ID, IP address, age, device model, OS version |
| Applovin | U.S.A | https://www.applovin.com/privacy/ | Upon accessing and engaging with an ad and using Luckmon services | Advertising, rewards | Device ID and geographical information (including region, state, country) and advertising ID |
| AppsFlyer | U.S.A | http://appsflyer.com/services-privacy-policy/ | Upon accessing and engaging with an ad and using Luckmon services | Advertising, rewards, and fraud detection | Mobile application Google Ad ID, IP address, age, device model, OS version |
| Facebook | U.S.A | https://www.facebook.com/policy.php | Upon accessing and using Luckmon services | Used for business analytics to better understand how users interact with Luckmon Services | Google Advertising ID |
| Google | U.S.A | https://policies.google.com/privacy | Upon accessing and using Luckmon services | Used for business analytics to better understand how users interact with Luckmon Services | Google Advertising ID |
| Singular | U.S.A | http://singular.net/privacy-policy | Upon accessing and engaging with an ad and using Luckmon services | Advertising, rewards, and fraud detection | Device ID and geographical information (including region, state, country) and advertising ID |
| Tremendous | U.S.A | https://policies.google.com/privacy | Upon redeeming a reward | Sending gift card rewards | Email address, Nickname |
...
We are based in the United States and the information that we process is protected by American privacy laws. The information that we collect may be transferred, stored, or used in other jurisdictions, such as the United States, where some of our service providers may be located. While we protect your information by choosing appropriate service providers and having contractual safeguards in place with those vendors, the privacy laws in such jurisdictions may not be as protective as in, for example, Canada or the EEA, SUI & UK, and may be subject to access by foreign governments, with or without your knowledge.
...
This Privacy Policy is incorporated into and forms part of our Terms of Use, which outlines the terms and conditions you agree to when using the Services, and which can be found at the bottom of most pages of the Luckmon website.
